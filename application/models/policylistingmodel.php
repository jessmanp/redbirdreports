		...
		if ($status != '') {
			...
			switch ($status) {
    				case 'written':
        				...
        				break;
    				case 'issued':
        				$addedSQL .= ' AND policies.renewal = 0 AND policies.status = 2';
        				break;
        			case 'notissued':
