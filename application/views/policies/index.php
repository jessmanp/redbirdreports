...
<?php if ($policy->renewal == 1) { ?>
				<div class="col" style="width:4%;<?php echo $addStyle; ?>"><a class="policy-renewal-action" data-id="<?php echo $policy->id; ?>"><img src="/public/img/policy_edit_btn.png" class="policy-listing-button" alt="Renew" /></a></div>
